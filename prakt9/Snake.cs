...
namespace prakt9
{
    class Game
    {
        ...
        {
            MaxRightBoundary = 80,
            MaxBottomBoundary = 26
        }

        static readonly int x = (int)Boundary.MaxRightBoundary;
        static readonly int y = (int)Boundary.MaxBottomBoundary;
        ...
        static void Main()
        {
            Console.SetWindowSize((int)Boundary.MaxRightBoundary + 1, (int)Boundary.MaxBottomBoundary + 1);
            Console.SetBufferSize((int)Boundary.MaxRightBoundary + 1, (int)Boundary.MaxBottomBoundary + 1);
